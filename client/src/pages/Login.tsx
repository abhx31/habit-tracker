      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <Lock className="w-16 h-16 text-white/90 drop-shadow-lg" />
          </motion.div>
          {/* Heading */}
          <motion.h2
          ...
          >
            Sign in to continue to HabitFlow and manage your habits securely.
          </motion.p>
          {/* Feature List */}
          <motion.ul
            initial="hidden"
          ...
          >
            ...
            >
              <CheckCircle className="w-5 h-5 text-green-400" /> Secure &
              Private
            </motion.li>
            <motion.li
              variants={{
              ...
              className="flex items-center gap-3 text-white/90 text-base"
            >
              <CheckCircle className="w-5 h-5 text-green-400" /> Track Your
              Progress
            </motion.li>
            <motion.li
              variants={{
              ...
              className="flex items-center gap-3 text-white/90 text-base"
            >
              <CheckCircle className="w-5 h-5 text-green-400" /> Join the
              Community
            </motion.li>
          </motion.ul>
        </motion.div>
